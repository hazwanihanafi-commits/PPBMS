...
// prepare milestone rows from student.raw using calculateProgress on frontend if needed
const raw = student.raw || {};
const milestones = Object.keys(raw)
.filter(k => ["P1 Submitted","P3 Submitted","P4 Submitted","P5 Submitted","Submission Document P1","Submission Document P3","Submission Document P4","Submission Document P5"].includes(k))
...
<li><strong>P1:</strong> {raw["P1 Submitted"] || "Not Submitted"}</li>
<li><strong>P3:</strong> {raw["P3 Submitted"] || "Not Submitted"}</li>
<li><strong>P4:</strong> {raw["P4 Submitted"] || "Not Submitted"}</li>
<li><strong>P5:</strong> {raw["P5 Submitted"] || "Not Submitted"}</li>
</ul>
</div>
