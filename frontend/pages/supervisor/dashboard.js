  ...
  useEffect(() => {
    ...
    fetch(`${API}/api/supervisor/list`, {
      ...
      .then((data) => {
        ...
        list.forEach((s) => {
          // Compute progress based on P1, P3, P4, P5
          const completed = [
            s.raw["P1 Submitted"],
            s.raw["P3 Submitted"],
            s.raw["P4 Submitted"],
    ...
    <div className="max-w-7xl mx-auto p-6 space-y-6">
      ...
      <div className="rounded-xl p-6 bg-gradient-to-r from-purple-600 to-orange-400 text-white shadow-lg">
        ...
        <p className="text-lg opacity-90">
          Overview of your students' progress & performance.
        </p>
      </div>
      ...
      <div className="grid grid-cols-4 gap-4">
        {["Ahead", "On Track", "At Risk", "Behind"].map((cat) => {
          ...
          return (
            <div key={cat} className="rounded-xl bg-white p-4 shadow text-center">
        ...
        <table className="w-full text-sm">
          ...
          <tbody>
            {filtered.map((s, i) => (
              ...
              >
                <td className="p-3">
                  <Link href={`/supervisor/${encodeURIComponent(s.raw["Student's Email"])}`}>
