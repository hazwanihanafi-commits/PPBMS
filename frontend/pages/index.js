    ...
    <div className="px-6 md:px-16 py-14">
      ...
      <div className="flex items-center gap-3 mb-10">
        ...
        <div>
          ...
          <p className="text-sm text-gray-500">Postgraduate Progress & Benchmarking System</p>
        </div>
      </div>
      ...
      {/* MAIN TITLE */}
      <h1 className="max-w-3xl text-4xl md:text-6xl font-extrabold text-gray-900 leading-tight">
      ...
      {/* BUTTONS */}
      <div className="flex flex-wrap gap-4 mt-10 mb-14">
        <a href="/student/login" className="px-6 py-3 bg-purple-600 text-white rounded-full hover:bg-purple-700">
          Login as Student
        </a>

        <a href="/supervisor/login" className="px-6 py-3 border border-purple-600 text-purple-700 rounded-full hover:bg-purple-50">
          Login as Supervisor
        </a>

        <a href="/admin/login" className="px-6 py-3 border border-purple-600 text-purple-700 rounded-full hover:bg-purple-50">
          Login as Admin
        </a>
      </div>
      ...
      <div className="grid md:grid-cols-3 gap-6">
        ...
        <div className="p-6 bg-white rounded-2xl shadow-lg border border-gray-100">
          <div className="flex items-center gap-4">
            <div className="w-12 h-12 rounded-xl bg-purple-200 text-purple-700 flex items-center justify-center font-bold">ST</div>
            <div>
              <h3 className="font-semibold text-gray-900">Student</h3>
              <p className="text-xs text-purple-600">SECURE LOGIN</p>
            </div>
          </div>

          <p className="mt-4 text-sm text-gray-600">
            View timelines, upload documents, and monitor your progress.
          </p>
        ...
        <div className="p-6 bg-white rounded-2xl shadow-lg border border-gray-100">
          <div className="flex items-center gap-4">
            <div className="w-12 h-12 rounded-xl bg-purple-200 text-purple-700 flex items-center justify-center font-bold">SV</div>
            <div>
          ...
          <p className="mt-4 text-sm text-gray-600">
            Monitor supervisees, identify risks, and guide timely completion.
          </p>
        ...
        <div className="p-6 bg-white rounded-2xl shadow-lg border border-gray-100">
          <div className="flex items-center gap-4">
            <div className="w-12 h-12 rounded-xl bg-orange-200 text-orange-700 flex items-center justify-center font-bold">AD</div>
            <div>
          ...
          <p className="mt-4 text-sm text-gray-600">
            Configure programmes, cohorts, and generate quality reports.
          </p>
